    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                <StatCard title="Lifetime Value" value={`$${user.ltv.toFixed(2)}`} />
                <StatCard title="Gross Gaming Revenue" value={`$${user.ggr.toFixed(2)}`} />
                <StatCard title="Avg. Bet Size" value={`$${user.avgBetSize.toFixed(2)}`} />
                {churnScore !== undefined ? (
                    ...
                    />
                     ...
                     <StatCard title="Churn Prediction" value="N/A" />
                )}
            </div>
        </div>
    );
